...
export default function LoginPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const email = username === "liz" ? process.env.NEXT_PUBLIC_ADMIN_EMAIL : "";
